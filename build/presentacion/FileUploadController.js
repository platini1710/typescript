...
const responses_1 = require("@/infra/http/responses");
        ...
        handle(request) {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    const filesPaths = yield this.fileUpload.upload(files);
                    return (0, responses_1.ok)(filesPaths);
                }
                catch (error) {
                    return (0, responses_1.serverError)({ message: error.message });
                }
            });
        }
    };
